...
\vspace{0.2cm}
{\normalsize Corso di \textbf{Elementi di Intelligenza Artificiale}}\par
\vspace{0.1cm}
...
Il dataset copre la \textbf{stagione 2023/2024}, con puntate dall'1~aprile
al~31~marzo~2024.
...
concorrente, il \textbf{mese} della puntata o una stima del
\textbf{coinvolgimento narrativo} dell'episodio — non erano disponibili nel
dataset utilizzato o avrebbero richiesto un processo di raccolta dati
considerevolmente più complesso.
...
\begin{itemize}
  \item Estendere il dataset alle stagioni precedenti per aumentare la potenza
        statistica;
  \item Introdurre un modello di \textbf{regressione} per predire il valore
        esatto del ratio, anziché la sola classe;
...
a questa osservazione una dimensione predittiva: non solo il Dottore
\textit{si comporta} in modo sistematico, ma quel comportamento è
\textit{apprendibile} da un algoritmo addestrato su dati storici.
